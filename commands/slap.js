...
module.exports = {
  ...
  onStart: async function ({ api, event, args, message, usersData }) {
    ...
    try {
      ...
      const targetName = (targetProfile && (targetProfile.name || targetProfile.username)) || (usersData && usersData.getName ? await usersData.getName(targetID) : "Victim");
      ...
      if (tempPath) fs.unlink(tempPath).catch(() => {});
      return message.reply(`👋 ${senderID} slapped ${targetID}!`);
    }
  }
};
