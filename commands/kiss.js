...
module.exports = {
  ...
  onStart: async function ({ api, event, args, message, usersData }) {
    ...
    try {
      ...
      const targetName = (targetProfile && (targetProfile.name || targetProfile.username)) || (usersData && usersData.getName ? await usersData.getName(targetID) : "Crush");
      ...
      if (tempPath) fs.unlink(tempPath).catch(() => {});
      return message.reply(`💋 ${senderID} gave a sweet kiss!`);
    }
  }
};
