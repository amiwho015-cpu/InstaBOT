...
/**
 * remoteAuth.js — connect InstaBOT to a private ig-chat-api server.
 *
 * Preserves the working RPC and SSE bridge from lazyneoaz/Insta-Bot.
 *
 * Author: Saifullah Al Neoaz (https://github.com/lazyneoaz)
 * Adapted for: frnAlt/InstaBOT
 * License: MIT
 */
...
function login(options, callback) {
	...
	api.listen = api.listenMqtt = function (cb) {
		if (typeof cb !== "function") throw new Error("listen requires a callback");
