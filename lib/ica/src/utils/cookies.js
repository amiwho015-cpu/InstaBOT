...
class CookieUtils {
  ...
  static parse(cookieData) {
    ...
    if (typeof cookieData === 'object') {
      if (cookieData.cookies && Array.isArray(cookieData.cookies.cookies)) {
        return CookieJar.deserializeSync(cookieData.cookies);
      } else if (cookieData.cookies && Array.isArray(cookieData.cookies)) {
        return this.parseArray(cookieData.cookies, jar);
      } else if (cookieData.cookies && typeof cookieData.cookies === 'object' && cookieData.cookies.version) {
        return CookieJar.deserializeSync(cookieData.cookies);
      }
