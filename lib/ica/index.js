...
function buildApi(client) {
  return {
    ...
    // Session
    getSession:    ()       => client.exportSession ? client.exportSession('json') : client.serialize(),
    exportSession: (format) => client.exportSession ? client.exportSession(format) : client.serialize(),
